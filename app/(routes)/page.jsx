              ...
              <>
                ...
                <div className="flex justify-center items-center gap-4 mt-8">
                  <button
                    ...
                    className="px-4 py-2 bg-green-500 text-white rounded-md disabled:bg-gray-300 disabled:cursor-not-allowed hover:bg-green-600 transition"
                  >
                    Previous
                  </button>
                  ...
                  <button className="px-4 py-2 bg-green-500 text-white rounded-md disabled:bg-gray-300 disabled:cursor-not-allowed hover:bg-green-600 transition">
                    Next
                  </button>
                </div>
